...
def plot_figure(order):
    ...
    for driver in driver_num:
        ...
        pre_matching_waiting_time.append((get_avg_prematching_waiting_time(records,order)))
        ...
        driver_usage_rate.append(get_driver_delivery_ratio(records, start_time, end_time, driver))
