...
gps_1 = pd.read_csv('D:/Data/etaxi/extra.csv')
gps_2 = pd.read_csv('D:/Data/etaxi/extra_1_360059998_final.csv')
gps_3 = pd.read_csv('D:/Data/etaxi/extra_2_377_059_998_final.csv')
gps_4 = pd.read_csv('D:/Data/etaxi/extra_3_380000000_final.csv')
cancel_order = pd.read_csv('D:/Shen Zijian/Simulator_Broadcasting/Transpotation_Simulator-1/simulator/driver_cancel.csv')
...
def MLP_nn():
    data = pd.read_csv("D:/Simulator_Broadcasting/Transpotation_Simulator-1/simulator/train.csv")
    # data = data.dropna()
    print(data.columns)

    input_data = data.drop(['wait_time','trip_time','trip_distance','order_grid_id'], axis=1)
    print(input_data.columns)
    input_data = input_data.dropna()
    input = input_data.drop(['reward'],axis = 1)
    output = input_data['reward']
